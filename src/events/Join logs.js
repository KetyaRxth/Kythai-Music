  ...
  client.on("guildCreate", async (guild) => {
    try {
      ...
      let mb = new EmbedBuilder()
        ...
        .setDescription(
          `<:arrow:1425852712083390525> I come up with default prefix as : \`${client.config.prefix}\`\n<:arrow:1425852712083390525> I am a High Quality Rythmic music bot with lots of unique features\n<:arrow:1425852712083390525> I come up with different search engines, You may try out me with \`play\`\n<:arrow:1425852712083390525> If you find any bug or want any kind of help regarding our services of Floovi Bot\n<:arrow:1425852712083390525> Please consider Joining [Support server](${client.config.ssLink}) by clicking [here](${client.config.ssLink})`
        )
